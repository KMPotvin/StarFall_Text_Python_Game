...
print("Type the directions north, south, east, and west to navigate. Type exit to leave game.\n"
      ...
      "Find the 6 items needed to protect yourself and defeat the witch.")
...
def game_start():
    ...
    globals(current_room, player_items)
    while True:
...
game_start()
user_close = input("Would you life to play again. Type Y for yes and N for no")
if user_close == "Y":
    game_start()
elif user_close == "N":
